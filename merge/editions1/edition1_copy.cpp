...
public:
    ...
    // const std::priority_queue<std::pair<int, float>>& getNeigbors(int vertex) const 
    // {
    //     return adjLists[vertex];
    // }
    ...
    std::priority_queue<std::pair<int, float>, std::vector<std::pair<int, float>>, compare> getNeigbors(int vertex) const 
    {
        return adjLists[vertex];
    }
