...
int main() {
    ...
    std::string hnsw1_path = "sub1_hnsw_1M_t1.bin"; 
    std::string hnsw2_path = "sub2_hnsw_1M_t1.bin";
    std::string hnsw3_path = "sub3_hnsw_1M_t1.bin"; 
    ...
    //     #pragma omp for
        ...
        for (size_t i = 2 * share + remainder; i < num_base; i++) {
            hnsw3->addPoint((void *)(base_vectors.data() + i * dim), i);
        }
    // }
