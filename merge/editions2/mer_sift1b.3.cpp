...
int dim = 128;   int max_elements = 10000000;
...
int main() {
    ...
    cout << "10M elements,   128 dim,   16 M,   200 ef_construction,   10 ef_search." << endl;
    cout << endl;
    ...
    std::string mer_hnsw_path = "mer_hnsw_10M_t80.bin";
